  ...
  return (
    <div>
      <p>
        ...
        cancers and food. After finishing with chemotherapy, she moved back home
        to pursue more knowledge in nutrition. She graduated from the University
        of Arizona with a B.S. in Nutritional Sciences and a minor in chemistry.
        She has worked several years teaching classes and providing coaching for
        people who wanted to make changes for the betterment of their health.
      </p>
      <p>
        Currently attending a 12 week course that covers the full-stack
        curriculum. Please check back for updates to this page with realized
        projects.
      </p>
      <p>
